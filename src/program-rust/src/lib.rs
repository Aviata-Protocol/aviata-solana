...
fn process_instruction(
    program_id: &Pubkey, // Public key of the account the avaita insurance program was loaded into
    accounts: &[AccountInfo], // The account to say hello to
    _instruction_data: &[u8], // Ignored, all avaitainsurance instructions are hellos
) -> ProgramResult {
    msg!("avaitainsurance Rust program entrypoint");
